...
// ❌ COMENTADO PARA DESENVOLVIMENTO - App Check causa erro sem reCAPTCHA válido
...
try {
  ...
  // Descomentar apenas em produção com reCAPTCHA v3 configurado
  /*
  try {
    const recaptchaKey = window.__RECAPTCHA_KEY || "SUA_CHAVE_RECAPTCHA_V3_VALIDA";
...
export { auth, db, db as rtdb, storage, messaging, firestore };
export default app;
