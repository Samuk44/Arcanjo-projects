// ===== wizard-pai.js =====
// SGE v2.0 • Responsável Registration Wizard • State Machine & Firebase Integration
...
const addAluno = () => {
  ...
  newCard.innerHTML = `
    ...
    <div>
      ...
      <input type="date" class="data-nascimento-aluno w-full px-4 py-2.5 bg-surface border border-border rounded-lg text-text focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition" required>
      <div class="error-message"></div>
    </div>
    ...
    try {
      ...
      await retryWithExponentialBackoff(() =>
        set(ref(db, `usuarios/${uid}`), {
          ...
          dataNascimento: state.step1.dataNascimento,
          role: "pai",
          status: "ativo",
