...
const FirebaseService = {
  loadVinculos: async () => {
    ...
    state.turmas = [
      { id: "9A",     nome: "9º Ano A" },
      { id: "1EM",    nome: "1º EM" },
      { id: "1TA-ADM", nome: "1º Ano A - Administração" },
      { id: "1TA-DS",  nome: "1º Ano A - Desenvolvimento de Sistemas" },
      { id: "1TA-LOG", nome: "1º Ano A - Logística" },
      { id: "1TA-ST",  nome: "1º Ano A - Segurança do Trabalho" },
      { id: "2TA-ADM", nome: "2º Ano A - Administração" },
      { id: "2TA-DS",  nome: "2º Ano A - Desenvolvimento de Sistemas" },
      { id: "2TA-LOG", nome: "2º Ano A - Logística" },
      { id: "2TA-ST",  nome: "2º Ano A - Segurança do Trabalho" },
      { id: "3TA-ADM", nome: "3º Ano A - Administração" },
      { id: "3TA-DS",  nome: "3º Ano A - Desenvolvimento de Sistemas" },
      { id: "3TA-LOG", nome: "3º Ano A - Logística" },
      { id: "3TA-ST",  nome: "3º Ano A - Segurança do Trabalho" },
    ];
    state.disciplinas = [
      { id: "FIS", nome: "Física" },
...
document.getElementById("btn-criar-avaliacao").addEventListener("click", () => {
  ...
  if (!/^\d{2}\/\d{2}\/\d{4}$/.test(data)) {
    UI.showToast("Data inválida. Use DD/MM/AAAA.", "error");
    document.getElementById("input-data-avaliacao").classList.add("border-red-500");
    return;
  }

  const dataFirebase = data.split("/").reverse().join("-");
...
document.addEventListener("DOMContentLoaded", function () {
  const el = document.getElementById("input-data-avaliacao");
  if (!el) return;
